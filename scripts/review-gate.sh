...
build_default_gates() {
  local candidates="test verify props test:props tokens test:css-contract test:contrast test:template-contract test:specimens test:review-gate test:contract build test:packed test:parity test:types check:exports"
  local parts=""
  local s
