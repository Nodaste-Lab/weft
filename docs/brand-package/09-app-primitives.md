...
Supersession banner is good, but the next sentence still teaches identity colour
as live instruction ("A person's identity colour drives their avatar…"). Agents
skimming past the bold note will re-implement weft#31. Strike or quarantine the
historical sentences; do not leave them as operative prose until W4.
-->
